...
type BusArrivalTestSuite struct {
	suite.Suite
	a       busArrival
	refTime time.Time
}

func (suite *BusArrivalTestSuite) SetupSuite() {
	suite.a = busArrival{}
	suite.refTime = time.Date(2016, time.April, 10, 0, 0, 0, 0, config.Timezone)
}

func (suite *BusArrivalTestSuite) SetupTest() {

}

func (suite *BusArrivalTestSuite) TestStarting() {
...
func (suite *BusArrivalTestSuite) TestNewTrain() {
...
func (suite *BusArrivalTestSuite) TestNoChanges() {
	t := test.GetTrain("passThrough")
	t.Route.CurrentStationOnSubroute = true
	req, upd, err := suite.a.Required(t, t, &suite.refTime)
	assert.NoError(suite.T(), err)
...
func (suite *BusArrivalTestSuite) TestDeleteTrain() {
...
func (suite *BusArrivalTestSuite) TestFirstRealtimeDelay() {
...
func (suite *BusArrivalTestSuite) TestChangeDelay() {
	t1 := test.GetTrain("passThrough")
	t2 := test.GetTrain("passThrough")
	t1.Route.CurrentStationOnSubroute = true
	t2.Route.CurrentStationOnSubroute = true
...
func (suite *BusArrivalTestSuite) TestRemoveDelay() {
	t1 := test.GetTrain("passThrough")
	t2 := test.GetTrain("passThrough")
	t1.Route.CurrentStationOnSubroute = true
	t2.Route.CurrentStationOnSubroute = true
...
func (suite *BusArrivalTestSuite) TestSwitchToManualMode() {
...
func (suite *BusArrivalTestSuite) TestUpdateManual() {
	t1 := test.GetTrain("passThrough")
	t2 := test.GetTrain("passThrough")
	t1.Route.CurrentStationOnSubroute = true
	t2.Route.CurrentStationOnSubroute = true
...
func (suite *BusArrivalTestSuite) TestManualDelay() {
	// new manual settings
	t1 := test.GetTrain("passThrough")
	t2 := test.GetTrain("passThrough")
	t1.Route.CurrentStationOnSubroute = true
...
func (suite *BusArrivalTestSuite) TestSwitchToAutoMode() {
	t1 := test.GetTrain("passThrough")
	t2 := test.GetTrain("passThrough")
	t1.Route.CurrentStationOnSubroute = true
	t2.Route.CurrentStationOnSubroute = true
...
func TestBusArrivalTestSuite(t *testing.T) {
	suite.Run(t, new(BusArrivalTestSuite))
}
